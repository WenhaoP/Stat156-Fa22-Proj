...
```{r}
# The IV-2SLS ﬁxed-effects results for the 25-death threshold are robust to dropping one country at a time. 
...
# coefﬁcients on economic growth
range(subset_iv[,'GDP_G.coef'])
# coefﬁcients on lagged economic growth
...
tiff("Plot1.tiff', device='tiff', dpi=700)
