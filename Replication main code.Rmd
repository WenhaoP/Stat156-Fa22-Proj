...
get_AR_pvals = function(y,z,d,with_cov=T, betas = seq(-10,10,0.1)){
  ...
  if (with_cov == F) {
    ...
    rformula = reformulate(c(grep('Iccyear',x = names(.data),value = T),X, 'GPCP_G'),response = 'adj_y')
  )
...
AR_pvals.Y1.z1.d1 = get_AR_pvals(y = 'ANY_PRIO', z  = 'GPCP_G', d = 'GDP_G', with_cov = T, betas = betas)
